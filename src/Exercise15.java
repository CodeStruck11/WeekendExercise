...
public TreeMap<Integer,Integer> calculateRevisedSalary(HashMap<Integer,String> m1,HashMap<Integer,Integer> m2){
...
public class Exercise15 {
	...
	public static void main(String[] args){
		...
		UserMainCode15 umc=new UserMainCode15();
		tm=umc.calculateRevisedSalary(m1, m2);
